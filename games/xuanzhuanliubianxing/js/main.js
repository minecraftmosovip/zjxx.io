...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>如何玩</div><p>旋转六边形的目标是阻止块离开外部灰色六边形的内部。</p><p>" + (settings.platform != 'mobile' ? '按左右箭头键' : '点击屏幕的左侧和右侧') + " 旋转六边形</p><p>通过重叠3个或更多相同颜色的块来清除块并获得分数。</p><p>您的连击消失之前剩余的时间 <span style='color:#f1c40f;'>由</span> <span style='color:#e74c3c'>外六边形</span> <span style='color:#3498db'>上的</span> <span style='color:#2ecc71'>彩色线条</span> 表示</p> <hr> <p id = 'afterhr'></p>");
	if (gameState == 1) {
		pause();
	}
